...
/***/ function(module, exports, __webpack_require__) {
	...
	var backEndEvents = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/*
	  ...
	  client remote, api local
	    https://ga-wdi-boston.github.io/front-end-group/?environment=development
	    This will require allowing "unsafe scripts" in Chrome
	  client remote, api remote
	    https://ga-wdi-boston.github.io/front-end-group/
	*/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  var data = store.user;
	  api.signOut(data).then(ui.signOutSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signOutSuccess = function signOutSuccess(data) {
	  ...
	  $('#myModal3').modal('hide');
	  $('.containera').show();
	  $('.options').empty().append("User Options");
	  $('.userIdMain').empty();
	  $('#viewAllSurveys').hide();
	  $('#outANDin').show();
	  $('#surveyOptions').hide();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onQuestionAppend = function onQuestionAppend(event) {
	  event.preventDefault();
	  var questionAppend = getFormFields(event.target);
	  api.questionAppend(questionAppend).then(ui.questionAppendSuccess).then(api.viewAllSurveys).then(ui.viewAllSurveysSuccess).catch(ui.questionAppendFailure);
	};

	var onDeleteSurvey = function onDeleteSurvey(event) {
	  event.preventDefault();
	  var deleteSurvey = getFormFields(event.target);
	  api.deleteSurvey(deleteSurvey["survey_id"]).then(ui.deleteSurveySuccess).catch(ui.deleteSurveyFailure);
	};
	//
	...
	var onViewYourSurveys = function onViewYourSurveys(event) {
	  event.preventDefault();
	  api.viewYourSurveys().then(ui.viewYourSurveysSuccess).catch(ui.viewYourSurveysFailure);
	};

	var onViewAllSurveys = function onViewAllSurveys(event) {
	  event.preventDefault();
	  api.viewAllSurveys().then(ui.viewAllSurveysSuccess).catch(ui.viewAllSurveysFailure);
	};
	...
	var onChangeTitle = function onChangeTitle(event) {
	  ...
	  api.changeTitle(data).then(ui.changeTitleSuccess).catch(ui.changeTitleFailure);
	};

	var addClueHandlers = function addClueHandlers() {
	...
	module.exports = {
	  addClueHandlers: addClueHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var questionAppend = function questionAppend(data) {
	  return $.ajax({
	...
	var appendAnswer = function appendAnswer(data) {
	  var id = data.survey.id;
	...
	var viewYourSurveys = function viewYourSurveys(data) {
	  return $.ajax({
	...
	var viewAllSurveys = function viewAllSurveys(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/surveys',
	    method: 'GET',
	    // headers: {
	...
	var changeTitle = function changeTitle(data) {
	  var id = data.survey._id;
	  delete data.survey.id;
	  return $.ajax({
	    url: config.apiOrigin + '/surveys/' + id,
	    method: 'PATCH',
	...
	module.exports = {
	  questionAppend: questionAppend,
	  deleteSurvey: deleteSurvey,
	  appendAnswer: appendAnswer,
	  viewYourSurveys: viewYourSurveys,
	  viewAllSurveys: viewAllSurveys,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(8);
	var showImagesTemplate = __webpack_require__(15);
	var showYourSurveysTemplate = __webpack_require__(35);
	var answersTemplate = __webpack_require__(36);
	var backendApi = __webpack_require__(13);
	...
	var viewYourSurveysSuccess = function viewYourSurveysSuccess(data) {
	  // store.user = data.user;
	  // console.log("data is ", data);
	  var fixedData = data.survey.map(function (survey) {
	    survey.answers = survey.answers.reduce(function (prev, curr) {
	      if (!prev[curr]) {
	        prev[curr] = 1;
	      } else {
	        prev[curr]++;
	...
	var viewYourSurveysFailure = function viewYourSurveysFailure(data) {
	  console.log("data fail is", data);
	};

	var questionAppendSuccess = function questionAppendSuccess(data) {
	...
	var questionAppendFailure = function questionAppendFailure(data) {
	  console.log(data);
	...
	var deleteSurveySuccess = function deleteSurveySuccess(data) {
	  console.log(data);
	  $('#signInBox').empty().append('Image Was Deleted');
	  $('#deleteSurvey').trigger('reset');
	  $('.surveysContainer').empty().show().append('That Survey was Deleted!');
	  $('#myModal6').modal('hide');
	};

	var deleteSurveyFailure = function deleteSurveyFailure(data) {
	  console.log("data is ", data);
	  $('#signInBox').empty().append('That May Not Belong To You (Or It May Not Exist)');
	};

	var appendAnswerSuccess = function appendAnswerSuccess(data) {
	  console.log(data);
	  $('#signInBox').empty().append('Image URL Was Updated');
	  $('.appendAnswer').trigger('reset');
	  $('.appendAnswer').hide();
	};

	var appendAnswerFailure = function appendAnswerFailure(data) {
	  console.log(data);
	  $('#signInBox').empty().append('Nope.  Something Went Wrong.');
	};

	var viewAllSurveysFailure = function viewAllSurveysFailure(data) {
	  console.log(data);
	  $('#signInBox').empty();
	};

	var changeTitleSuccess = function changeTitleSuccess(data) {
	  console.log(data);
	};

	var changeTitleFailure = function changeTitleFailure(data) {
	  console.log(data);
	};

	var viewAllSurveysSuccess = function viewAllSurveysSuccess(data) {
	  console.log(data);
	  //
	  ...
	  jQuery(function ($) {
	    ...
	    $('.imageImage').click(function () {
	      ...
	      // .append($(this).data());
	      $(".surveysAnswers").empty().show().html(answersTemplate(data));
	      $('#answerAppend').on('submit', function () {
	        event.preventDefault();

	        var answer = $('#answerInput').val();
	        var id = $('#surveyId').text();
	        var survey = {
	          survey: {
	            id: id,
	            answers: answer
	        ...
	        backendApi.appendAnswer(survey).then(console.log).catch(console.error);
	        // return false;
	      });
	...
	module.exports = {
	  failure: failure,
	  success: success,
	  questionAppendSuccess: questionAppendSuccess,
	  questionAppendFailure: questionAppendFailure,
	  deleteSurveySuccess: deleteSurveySuccess,
	  deleteSurveyFailure: deleteSurveyFailure,
	  appendAnswerSuccess: appendAnswerSuccess,
	  appendAnswerFailure: appendAnswerFailure,
	  viewYourSurveysSuccess: viewYourSurveysSuccess,
	  viewYourSurveysFailure: viewYourSurveysFailure,
	  viewAllSurveysSuccess: viewAllSurveysSuccess,
	  viewAllSurveysFailure: viewAllSurveysFailure,
	  changeTitleSuccess: changeTitleSuccess,
	  changeTitleFailure: changeTitleFailure
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return " <div class=\"imageImage\">\n   <span class=\"svy-btn\" data-id=\""
	    ...
	    + "</h2>\n     <span id=\"surveyId\" hidden=\"true\">"
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "</span>\n   </span>\n</div>\n<hr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.surveys : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class=\"imageImage\">\n    <h1>Title: "
	    ...
	    + alias4(((helper = (helper = helpers.question || (depth0 != null ? depth0.question : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"question","hash":{},"data":data}) : helper)))
	    + "</h4>\n</div>\n<div class=\"imageImage\">\n      Answers:\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.answers : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</div>\n<div class=\"imageImage\">\n  <form class=\"delSurvey\">\n    <fieldset>\n      <input type=\"hidden\" name=\"survey_id\" value=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">\n      <input type=\"submit\" name=\"submit\" value=\"DELETE!\">\n    </fieldset>\n  </form>\n</div>\n<div class=\"imageImage\" data-id="
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + ">\n  <form class=\"changeTitle\">\n    <fieldset>\n      <input type=\"hidden\" name=\"survey[_id]\" value=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">\n      <input type=\"text\" name=\"survey[title]\" value=\""
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.survey : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "\n\n<div class=\"appendAnswer\">\n  <form id=\"answerAppend\">\n    <fieldset>\n      <legend>Enter Answer HERE</legend>\n      <input type=\"text\" name=\"survey[answer]\" id=\"answerInput\" placeholder=\"Answer\">\n      <input type=\"submit\" name=\"submit\" value=\"Append Answer!\">\n    </fieldset>\n  </form>\n</div>\n";
	},"useData":true});
